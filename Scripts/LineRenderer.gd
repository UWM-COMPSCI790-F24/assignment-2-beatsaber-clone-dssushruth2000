...
func _on_right_controller_button_pressed(name: String) -> void:
    if name == "ax_button":  
        var right_sword = get_node("/root/Main/XROrigin3D/RightController/RightLaserSword")
        var right_raycast = get_node("/root/Main/XROrigin3D/RightController/RightLaserSword/RightSwordRayCast3D")
        if right_sword != null:  
            print("Right sword toggle input detected")
            right_sword.visible = !right_sword.visible
            right_raycast.enabled = right_sword.visible
            print("Right sword visibility: ", right_sword.visible)
        else:
            print("RightLaserSword not found!")
...
func _on_left_controller_button_pressed(name: String) -> void:
     if name == "ax_button":  
        var left_sword = get_node("/root/Main/XROrigin3D/LeftController/LeftLaserSword")
        var left_raycast = get_node("/root/Main/XROrigin3D/LeftController/LeftLaserSword/LeftSwordRayCast3D")
        if left_sword != null:  
            print("Left sword toggle input detected")
            left_sword.visible = !left_sword.visible
            left_raycast.enabled = left_sword.visible
            print("Left sword visibility: ", left_sword.visible)
        else:
            print("LeftLaserSword not found!")
